...
PACKAGE_INSTALL = "ca-certificates sysvinit busybox-udhcpd dnsmasq date-sync logrotate cronie azure-complete-provisioning ${CVM_DEPS} ${VIRTUAL-RUNTIME_base-utils} ${ROOTFS_BOOTSTRAP_INSTALL}"
